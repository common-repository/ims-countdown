<?php 
		...
		$sec_ds  = intval($ds)*86400;
		$sec_hr  = intval($hr)*3600;
		$sec_mn  = intval($mn)*60;
		$timeGap = $sec_ds+$sec_hr+$sec_mn+intval($sc);
		...
		wp_enqueue_script( 'imsc_custom_jquery-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js' );
